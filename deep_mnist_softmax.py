...
# -----------------------------------------------------------------------------------------------
# convolution, slide a 5x5 patch around each image, with 1 color channel, producing 32 features
W_conv1 = weight_variable([5, 5, 1, 32])
b_conv1 = bias_variable([32])
# reshape x to be a 4d tensor (?, width, height, num_color_channels)
...
# -----------------------------------------------------------------------------------------------
# deep network, stack next layer with 64 features for each 5x5 patch
